export default function Footer() {
  return (
    <footer style={{ borderTop: '1px solid var(--border-dim)', paddingTop: '1.25rem', paddingBottom: '1.25rem', color: 'var(--text-secondary)' }}>
      <div style={{ maxWidth: '7xl', marginLeft: 'auto', marginRight: 'auto', paddingLeft: '1.75rem', paddingRight: '1.75rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
